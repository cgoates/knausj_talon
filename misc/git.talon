...
git checkout patch: "git checkout -p .\n"
...
git commit fixup back <number_small>: "git commit --fixup HEAD~{number_small}"
...
git push set up stream origin: "git push --set-upstream origin "
git push set up stream origin <user.text>: "git push --set-upstream origin {text}"
git push <user.text>: "git push {text} "
git push tags: "git push --tags\n"
git rebase: "git rebase "
git rebase on master: "git rebase -i origin/master"
